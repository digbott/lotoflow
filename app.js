            ...
            <div className="form-card">
              <div className="form-grid">
                ...
                {(() => {
                  ...
                  const entDestino = entidades.find(e => e.nome === form.destino);
                  const isOp = entOrigem?.roles.includes("operador") || entDestino?.roles.includes("operador");
                  const showCofre = form.descricao === "Recebeu de" && isOp
                    && (form.origem === "Lotérica" || form.destino === "Lotérica");
